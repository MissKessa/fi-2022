...
def substitution(message,alphabet):
    """Your function should take two parameters, the message you want to dencrypt, and a
string that represents the mapping of the 26 letters in the alphabet. Your function should
return a string that is the dencrypted version of the message"""
